...
- It seems that changing a set, e.g. union of two sets, is not allowed in gams as easily as it might seem. For this purpose, you need to define **dynamic sets**! (read more about them [here](https://www.gams.com/48/docs/UG_DynamicSets.html?search=union%20of%20sets))
