...
- The AGV cannot turn multiple times in the seaside and landside operation areas. This means than AGV cannot change horizontal lanes once it is in the seaside ($$y \in \{1,\dots, y_r\}\quad  \text{or}\,\,\,\, y \in \{ y_{r+1}, \dots, y_R\}$$) 
...
- list of $$\psi_1$$ and $$\psi_2$$, showing the ordering of jobs??
- Node N:
  - $$\tau$$ the height
  - v the index
