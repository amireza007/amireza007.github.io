...
This article is an important contribution to AGV-related problems because **the assumed path layout is bidirectional AND it aims to avoid congestion and conflict.**
