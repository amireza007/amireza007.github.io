...
1. بیا روی این دکمه بزن تا دانلود کنی برنامه رو <button class="button-12" role="button" onclick="myfunc()">**روم بزن!**</button>
2. اینو بزن تا کپی بشه بعد طبق دو عکس زیر، پیستشون کن!
   <div id="cu">
   <button class="button-12" type="submit" role="button" onclick="copy()" value="copy">بزن روم! جوووون!
   </button>
...
function copy2(){
    ...
    url.select();
    document.getElementById("custom-tooltip2").style.display = "inline-flex";
    document.execCommand("copy");
    setTimeout( function() {
